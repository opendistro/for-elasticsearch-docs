...
1. Download the tarball:
   ...
   ```bash
   curl https://d3g5vo6xdbdb9a.cloudfront.net/tarball/opendistro-elasticsearch/opendistroforelasticsearch-1.10.0.tar.gz -o opendistroforelasticsearch-1.10.0.tar.gz
   ```

1. Download the checksum:

   ```bash
   curl https://d3g5vo6xdbdb9a.cloudfront.net/tarball/opendistro-elasticsearch/opendistroforelasticsearch-1.10.0.tar.gz.sha512 -o opendistroforelasticsearch-1.10.0.tar.gz.sha512
   ```

1. Verify the tarball against the checksum:

   ```bash
   shasum -a 512 -c opendistroforelasticsearch-1.10.0.tar.gz.sha512
   ```
...
1. Extract the TAR file to a directory and change to that directory:
   ...
   ```bash
   tar -zxf opendistroforelasticsearch-1.10.0.tar.gz
   cd opendistroforelasticsearch-1.10.0
   ```
