...
1. Run `docker pull amazon/opendistro-for-elasticsearch-kibana:1.10.0`.
...
1. Download the tarball:
   ...
   ```bash
   curl https://d3g5vo6xdbdb9a.cloudfront.net/tarball/opendistroforelasticsearch-kibana/opendistroforelasticsearch-kibana-1.10.0.tar.gz -o opendistroforelasticsearch-kibana-1.10.0.tar.gz
   ```

1. Download the checksum:

   ```bash
   curl https://d3g5vo6xdbdb9a.cloudfront.net/tarball/opendistroforelasticsearch-kibana/opendistroforelasticsearch-kibana-1.10.0.tar.gz.sha512 -o opendistroforelasticsearch-kibana-1.10.0.tar.gz.sha512
   ```

1. Verify the tarball against the checksum:

   ```bash
   shasum -a 512 -c opendistroforelasticsearch-kibana-1.10.0.tar.gz.sha512
   ```
...
1. Extract the TAR file to a directory and change to that directory:
   ...
   ```bash
   tar -zxf opendistroforelasticsearch-kibana-1.10.0.tar.gz
...
1. Extract [the ZIP file](https://d3g5vo6xdbdb9a.cloudfront.net/downloads/odfe-windows/ode-windows-zip/odfe-1.10.0-kibana.zip) to a directory and open that directory at the command prompt.
...
1. Download [the EXE file](https://d3g5vo6xdbdb9a.cloudfront.net/downloads/odfe-windows/odfe-executables/Open_Distro_For_Elasticsearch_Kibana_1.10.0.exe), run it, and click through the steps.
