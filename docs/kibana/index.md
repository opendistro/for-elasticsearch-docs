...
1. Download the tarball:
   ...
   ```bash
   curl https://d3g5vo6xdbdb9a.cloudfront.net/tarball/opendistroforelasticsearch-kibana/opendistroforelasticsearch-kibana-1.3.0.tar.gz -o opendistroforelasticsearch-kibana-1.3.0.tar.gz
   ```

1. Download the checksum:

   ```bash
   curl https://d3g5vo6xdbdb9a.cloudfront.net/tarball/opendistroforelasticsearch-kibana/opendistroforelasticsearch-kibana-1.3.0.tar.gz.sha512 -o opendistroforelasticsearch-kibana-1.3.0.tar.gz.sha512
   ```

1. Verify the tarball against the checksum:

   ```bash
   shasum -a 512 -c opendistroforelasticsearch-kibana-1.3.0.tar.gz.sha512
   ```
...
1. Extract the TAR file to a directory and change to that directory:
   ...
   ```bash
   tar -zxf opendistroforelasticsearch-kibana-1.3.0.tar.gz
