...
1. Create a new `Dockerfile`:
   ...
   ```
   FROM amazon/opendistro-for-elasticsearch-kibana:1.8.0
...
1. In `docker-compose.yml`, change `amazon/opendistro-for-elasticsearch-kibana:1.8.0` to `kibana-no-security`.
