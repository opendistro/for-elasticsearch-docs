...
Monitors can run at a variety of fixed intervals (e.g. hourly, daily, etc.), but you can also define custom cron expressions for when they should run. Cron expressions in monitors support five fields:
...
Note that you can specify days using two fields: day of month and day of week. For most situations, we recommend that you use just one of these fields and leave the other as `*`.
...
Every 10 minutes, Saturday and Sunday:
