...
:--- | :--- | :--- | :---
[1.13.1](https://github.com/opendistro-for-elasticsearch/opendistro-build/blob/main/release-notes/opendistro-for-elasticsearch-release-notes-1.13.1.md) | Fixes bugs with Performance Analyzer failing to start and the security plugin blocking requests to `_cat/health`. | 2 March 2021 | 7.10.2
