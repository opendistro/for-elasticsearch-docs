...
:--- | :--- | :--- | :---
[1.12.0](https://github.com/opendistro-for-elasticsearch/opendistro-build/blob/master/release-notes/opendistro-for-elasticsearch-release-notes-1.12.0.md) | Adds Kibana reports, index rollups, Hamming distance for KNN, and the experimental Trace Analytics feature | 10 December 2020 | 7.10.0
